...
class MyQuestionsAdapter(private val context: Context) : RecyclerView.Adapter<MyQuestionsAdapter.MyQuestionsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyQuestionsViewHolder {
        ...
        return MyQuestionsViewHolder(context, view)
    }
    ...
    class MyQuestionsViewHolder(context: Context, itemView: View) : RecyclerView.ViewHolder(itemView),
        LayoutContainer {
